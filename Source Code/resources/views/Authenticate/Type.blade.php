    ...
    <section class="w-[85%] h-[100vh] mx-auto flex flex-col justify-center" >
        ...
        <section class="flex justify-between items-center" >
            <div class="w-[45%] flex justify-around items-center border-2 border-gray-500 py-6 px-4 bg-gray-200 hover:bg-gray-100" >
                ...
                <div class="w-[50%]">
                    <h1 class="text-xl font-[600] mb-2" ><a href="/driverRegistration" >Register As A Driver !</a></h1>
            ...
            <div class="w-[45%] flex justify-around items-center border-2 border-gray-500 py-6 px-4 bg-gray-200 hover:bg-gray-100" >
                ...
                <div class="w-[50%]" >
                    <h1 class="text-xl font-[600] mb-2" ><a href="/passengerRegistration" >Register As A Passenger !</a></h1>
